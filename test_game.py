...
from utilities import determine_winner
from game import test_step, game_setup
...
def test_game(num, strategy, arg):
    ...
    while num > 0:
        ...
        while True:
            ...
            if br_flag: break
            A, B, CARDS, SEEN, hmaid_A, hmaid_B, known_A, known_B, win_flag = test_step(
                ['A', 'B'][cnt % 2], A, B, CARDS, SEEN, hmaid_A, hmaid_B,
                known_A, known_B, strategy, arg)
            cnt = 1 - cnt
